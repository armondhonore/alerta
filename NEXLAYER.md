...
**Live:** [https://relaxed-weasel-alerta.cloud.nexlayer.ai](https://relaxed-weasel-alerta.cloud.nexlayer.ai)  

**Runtime:** python-static · **Port:** 80 · **Deploy branch:** main

---

## How this deployment works

**alerta** is deployed on [Nexlayer](https://nexlayer.ai) — a container-native
...
application:
  ...
  pods:
    - name: app
      image: "registry.nexlayer.io/user_01kece1xyh817dwff7wnarhkxd/alerta:9f1ffa1-fix4"
      path: /
      servicePorts:
        - 8080
      vars: {}
